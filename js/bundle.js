...
function calculator() {
  ...
  initCalcSettings(".calculating__choose.calculating__choose_big div", "calculating__choose-item_active");
  function calcTotal() {
  ...
  getStaticInfo(".calculating__choose.calculating__choose_big div", "calculating__choose-item_active");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.postData)("http://localhost:3000/requests", json).then(data => {
        console.log(data);
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2025-12-22");
